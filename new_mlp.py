...
X_merged = pd.read_pickle("./merged_Brazil_filtered_shifted_x_numeric_new.pkl")

X = X_merged[(X_merged['Report_Year']==2015) | (X_merged['Report_Year']==2016) | (X_merged['Report_Year']==2017)]


X = X.sample(frac=1).reset_index(drop=True)

X = X_merged[X_merged['Status']==False][:2600]
