...
def split_files():
    df_original = pd.read_excel('./data_files/China_Global Data_Mulpyears_Demo__09172019_2015 added.xlsx', sheet_name='Data')
...
def pickle_dataframe():
    ...
    df_name = 'merged_China_combined_fixed'
    ...
    data_x_numeric.to_pickle("./data_files/CHINA/"+df_name+"_x_numeric.pkl")
    data_x_numeric.to_csv("./data_files/CHINA/" + df_name + "_x_numeric.csv", sep=',', encoding='utf-8')
...
def merge_files():
    ...
    df_2016 = pd.read_csv('data_files/CHINA/2016_fixed.csv', sep=',')
    df_2017 = pd.read_csv('data_files/CHINA/2017_fixed.csv', sep=',')
    df_2018 = pd.read_csv('data_files/CHINA/2018_fixed.csv', sep=',')
    df_2019 = pd.read_csv('data_files/CHINA/2019_fixed.csv', sep=',')
    ...
    df_merged.to_csv('data_files/CHINA/merged_China_combined_fixed.csv', sep=',', encoding='utf-8')
...
def pickle_current_file():
    ...
    df_original = df_original[df_original['Working_Country_Fixed'] == 'China']
    df_original.info()
    df = pd.DataFrame()
